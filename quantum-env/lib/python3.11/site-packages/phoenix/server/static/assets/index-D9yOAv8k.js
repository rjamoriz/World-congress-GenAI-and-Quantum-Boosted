import{U as e,j as o,ea as y,eb as x,ec as z,ed as w,V as g,cA as P,ee as l,r as k,o as S,ef as L}from"./vendor-lqxaAnN2.js";import{L as R,h as C,r as E,i as I,j,F as A,k as D,P as F,l as T,M as d,n as M,D as G,o as _,E as O,p as V,q as N,s as W,t as B,v as m,w as q,x as U,y as $,z as K,B as H,C as J,G as Q,H as X,I as Y,J as Z,K as oo,N as p,O as u,Q as lo,U as ao,V as ro,W as co,X as go,Y as eo,Z as bo,_ as no,$ as io,a0 as so,a1 as to,a2 as mo,a3 as po,a4 as uo,a5 as fo,a6 as vo,a7 as f,a8 as ho,a9 as yo,aa as xo,ab as zo,ac as wo,ad as v,ae as h,af as Po,ag as ko,ah as So,ai as Lo,aj as Ro,ak as Co,al as Eo,am as Io,an as jo,ao as Ao,ap as Do,aq as Fo,ar as To,as as Mo,at as Go,au as _o,av as Oo,aw as i,ax as Vo,ay as No,az as Wo,aA as Bo,aB as qo,aC as Uo,aD as $o,aE as Ko}from"./pages-CXp0M-wB.js";import{db as Ho,gj as Jo,R as Qo,gk as Xo}from"./components-C40LMnn_.js";import"./vendor-three-BtCyLs1w.js";import"./vendor-codemirror-Ci4D0cBP.js";import"./vendor-shiki-BIjPbHhu.js";import"./vendor-recharts-DYROl3N9.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))t(c);new MutationObserver(c=>{for(const b of c)if(b.type==="childList")for(const s of b.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function n(c){const b={};return c.integrity&&(b.integrity=c.integrity),c.referrerPolicy&&(b.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?b.credentials="include":c.crossOrigin==="anonymous"?b.credentials="omit":b.credentials="same-origin",b}function t(c){if(c.ep)return;c.ep=!0;const b=n(c);fetch(c.href,b)}})();const Yo=e`
  :root,
  .ac-theme {
...
`;function il(){const{theme:a}=Ho();return o(y,{styles:e(ol,Zo,a==="dark"?ll:al,rl(a),Yo,cl,gl,el,bl,nl)})}const sl=x(z(g(l,{path:"/",errorElement:o(i,{}),element:o(qo,{}),children:[o(l,{path:"/v1/*",element:o(P,{to:"/",replace:!0})}),o(l,{path:"/login",element:o(R,{})}),o(l,{path:"/logout",element:o(C,{})}),o(l,{path:"/reset-password",element:o(I,{}),loader:E}),o(l,{path:"/reset-password-with-token",element:o(j,{})}),o(l,{path:"/forgot-password",element:o(A,{})}),o(l,{element:o(Bo,{}),loader:D,children:g(l,{element:o(Wo,{}),children:[o(l,{path:"/profile",handle:{crumb:()=>"profile"},element:o(F,{})}),o(l,{index:!0,loader:T}),g(l,{path:"/model",handle:{crumb:()=>"model"},element:o(V,{}),children:[o(l,{index:!0,element:o(d,{})}),o(l,{element:o(d,{}),children:o(l,{path:"dimensions",children:o(l,{path:":dimensionId",element:o(G,{}),loader:M})})}),o(l,{path:"embeddings",children:o(l,{path:":embeddingDimensionId",element:o(O,{}),loader:_,handle:{crumb:a=>a.embedding.name}})})]}),g(l,{path:"/projects",handle:{crumb:()=>"Projects"},element:o(Z,{}),children:[o(l,{index:!0,element:o(N,{})}),g(l,{path:":projectId",loader:W,handle:{crumb:a=>{var r;return(r=a==null?void 0:a.project)==null?void 0:r.name}},element:o(Y,{}),children:[o(l,{index:!0,element:o(B,{})}),g(l,{element:o(X,{}),children:[o(l,{path:"traces",element:o(q,{}),children:o(l,{path:":traceId",element:o(m,{})})}),o(l,{path:"spans",element:o(U,{}),children:o(l,{path:":traceId",element:o(m,{})})}),o(l,{path:"sessions",element:o(H,{}),children:o(l,{path:":sessionId",element:o(K,{}),loader:$})}),o(l,{path:"config",element:o(J,{})}),o(l,{path:"metrics",element:o(Q,{})})]})]})]}),g(l,{path:"/datasets",handle:{crumb:()=>"Datasets"},children:[o(l,{index:!0,element:o(oo,{})}),g(l,{path:":datasetId",loader:p,handle:{crumb:a=>{var r;return(r=a==null?void 0:a.dataset)==null?void 0:r.name}},children:[g(l,{element:o(bo,{}),loader:p,children:[o(l,{index:!0,element:o(u,{})}),o(l,{path:"experiments",element:o(u,{})}),o(l,{path:"examples",element:o(ro,{}),loader:lo,children:o(l,{path:":exampleId",element:o(ao,{})})}),o(l,{path:"versions",element:o(go,{}),loader:co}),o(l,{path:"evaluators",element:o(eo,{})})]}),o(l,{path:"compare",element:o(no,{}),handle:{crumb:()=>"compare"}})]})]}),g(l,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(l,{index:!0,element:o(io,{})}),o(l,{path:"spans/:spanId",element:o(to,{}),loader:so,handle:{crumb:a=>{var r;return(a==null?void 0:a.span.__typename)==="Span"?`span ${(r=a==null?void 0:a.span)==null?void 0:r.spanId}`:"span unknown"}}})]}),g(l,{path:"/prompts",handle:{crumb:()=>"Prompts"},children:[o(l,{index:!0,element:o(po,{}),loader:mo}),g(l,{path:":promptId",loader:uo,shouldRevalidate:()=>!0,handle:{crumb:a=>{var r,n;return((r=a==null?void 0:a.prompt)==null?void 0:r.__typename)==="Prompt"?(n=a==null?void 0:a.prompt)==null?void 0:n.name:"prompt unknown"}},children:[g(l,{element:o(wo,{}),children:[o(l,{index:!0,element:o(fo,{})}),o(l,{path:"versions",loader:vo,element:o(yo,{}),children:o(l,{path:":versionId",loader:f,element:o(ho,{})})}),o(l,{path:"config",element:o(zo,{}),loader:xo})]}),o(l,{path:"versions/:versionId",loader:f,handle:{crumb:a=>a==null?void 0:a.promptVersion.id},children:o(l,{path:"playground",element:o(h,{}),loader:v,handle:{crumb:()=>"playground"}})}),o(l,{path:"playground",element:o(h,{}),loader:v,handle:{crumb:()=>"playground"}})]})]}),o(l,{path:"/apis",element:o(Po,{}),handle:{crumb:()=>"APIs"}}),o(l,{path:"/support",element:o(ko,{}),handle:{crumb:()=>"Support"}}),g(l,{path:"/settings",element:o(_o,{}),handle:{crumb:()=>"Settings"},children:[o(l,{path:"general",loader:So,element:o(Lo,{}),handle:{crumb:()=>"General"}}),o(l,{path:"providers",loader:Ro,element:o(Co,{}),handle:{crumb:()=>"AI Providers"}}),o(l,{path:"models",loader:Eo,element:o(Io,{}),handle:{crumb:()=>"Models"}}),o(l,{path:"datasets",element:o(jo,{}),handle:{crumb:()=>"Datasets"}}),o(l,{path:"annotations",loader:Ao,element:o(Do,{}),handle:{crumb:()=>"Annotations"}}),o(l,{path:"data",element:o(To,{}),handle:{crumb:()=>"Data Retention"},loader:Fo}),o(l,{path:"prompts",element:o(Go,{}),loader:Mo,handle:{crumb:()=>"Prompts"}})]}),o(l,{path:"/redirects/spans/:span_otel_id",loader:Oo,errorElement:o(i,{})}),o(l,{path:"/redirects/traces/:trace_otel_id",loader:Vo,errorElement:o(i,{})}),o(l,{path:"/redirects/sessions/:session_id",loader:No,errorElement:o(i,{})})]})})]})),{basename:window.Config.basename});function tl(){return o(w,{router:sl})}function dl(){return o(Uo,{children:o(Jo,{children:o(ml,{})})})}function ml(){return g(S.RelayEnvironmentProvider,{environment:Qo,children:[o(il,{}),o(Ko,{children:o(Xo,{children:o($o,{children:o(k.Suspense,{children:o(tl,{})})})})})]})}const pl=document.getElementById("root"),ul=L.createRoot(pl);ul.render(o(dl,{}));
